...
TfLiteDelegate* CreateEspDelegateFromOptions(
  ...
  constexpr char kEspDelegateParsing[] = "esp_delegate_parsing";
  argv.push_back(kEspDelegateParsing);
  ...
  TFLITE_LOG(INFO) << "Esp delegate: allowed_builtin_code set to "
                   << options.allowed_builtin_code << ".";
  TFLITE_LOG(INFO) << "Esp delegate: error_during_init set to "
                   << options.error_during_init << ".";
  TFLITE_LOG(INFO) << "Esp delegate: error_during_prepare set to "
                   << options.error_during_prepare << ".";
  TFLITE_LOG(INFO) << "Esp delegate: error_during_invoke set to "
                   << options.error_during_invoke << ".";
...
tflite_plugin_create_delegate(const char* const* options_keys,
  ...
  return tflite::tools::CreateEspDelegateFromOptions(
